...
HTML = HERE / "from-mice-to-humans-report.html"
OUT = HERE / "from-mice-to-humans-report.pptx"
...
def main() -> None:
    ...
    prs.core_properties.title = "From mice to humans — report"
    ...
    prs.core_properties.subject = ("Multi-omic predictive framework for translational "
                                   "immunology — report deck")
    prs.core_properties.comments = ("Editable PowerPoint built from the report deck "
                                    "(build_pptx.py).")
    prs.save(OUT)
