---
pagetitle: "From mice to humans — lab meeting"
format:
  revealjs:
...
## From mice to humans {#sec-from-mice-to-humans .titleslide}

<p class="kicker">

A multi-omic predictive framework for translational immunology
...
::: fig
![](img/01-graphical-abstract.png)
:::

## 01 · The problem {.bigstats}
...
## 06 · Result — evolution & regulation {.tallfig}
